export default {
  ...
  'menu.datamanager.historyrecord': '历史记录',

  'menu.devicemanager': '设备管理',
  'menu.devicemanager.devicelist': '设备列表',
  'menu.devicemanager.adddevice': '创建设备',
  'menu.devicemanager.devicegroup': '设备分组',
  'menu.devicemanager.cyclemanager': '生命周期管理',

  'menu.triggermanager': '触发器管理',
  'menu.triggermanager.triggerlist': '触发器列表',
  'menu.triggermanager.addtrigger': '添加触发器',
  'menu.triggermanager.alarmcontact': '报警联系人/组',
  'menu.triggermanager.alarmrecord': '报警记录',

  'menu.useradmin': '用户中心',
  'menu.useradmin.usermanager': '用户管理',
  ...
  'menu.examples.list': '列表页',
  'menu.examples.list.searchtable': '查询表格',
  'menu.examples.list.basiclist': '标准列表',
  'menu.examples.list.cardlist': '卡片列表',
  'menu.examples.list.searchlist': '搜索列表',
  'menu.examples.list.searchlist.articles': '搜索列表（文章）',
  'menu.examples.list.searchlist.projects': '搜索列表（项目）',
  'menu.examples.list.searchlist.applications': '搜索列表（应用）',

  'menu.examples.profile': '详情页',
  'menu.examples.profile.basic': '基础详情页',
  'menu.examples.profile.advanced': '高级详情页',

  'menu.examples.result': '结果页',
  'menu.examples.result.success': '成功页',
  'menu.examples.result.fail': '失败页',
  'menu.examples.exception': '异常页',
  'menu.examples.exception.not-permission': '403',
